...
> The explanation I stole from someone else online. Here for my own edification (https://rforhr.com/compositevariable.html).

> Fourth, we will type the name of the rowMeans function. 
> Fifth, as the first argument, type the name of the data frame object to which the items belong (df). 
...
write.csv(study1, file = "Study1_data_Rclean.csv")